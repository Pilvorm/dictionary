  ...
  return (
    <div className="flex flex-col gap-7 md:gap-12 animate-pulse">
      <div className="flex items-center justify-between">
        <div>
          <div className="h-12 w-56 bg-neutral-200 rounded"></div>
          <div className="md:mt-3 h-8 w-36 bg-neutral-200 rounded"></div>
        </div>

        <div className="w-[48px] h-[48px] md:w-[75px] md:h-[75px] rounded-full bg-neutral-200 "></div>
      </div>
      ...
      <div className="flex flex-col gap-10">
        ...
        <div>
          ...
          <ul className="meaning-list">
            <li className="md:mt-3 h-8 w-full bg-neutral-200 rounded"></li>
          </ul>
        </div>
